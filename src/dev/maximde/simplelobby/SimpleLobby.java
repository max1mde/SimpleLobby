    ...
    public boolean VersionChecker() {
    	...
    	try {
			...
			if(SimpleLobby.serverVersion.equals("v1_8_R3")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_9_")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_10_")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_11_")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_12_")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_13_")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_14_")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_15_")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_16_")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_17_")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_18_")) {
				return true;
			} else if(SimpleLobby.serverVersion.contains("v1_19_")) {
				return true;
			} else {
				return false;
			}
